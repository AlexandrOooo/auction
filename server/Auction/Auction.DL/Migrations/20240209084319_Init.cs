    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersAuctions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersAuctions_Auctions_AuctionId",
                        column: x => x.AuctionId,
                        principalTable: "Auctions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersAuctions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersAuctions_AuctionId",
                table: "UsersAuctions",
                column: "AuctionId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersAuctions_UserId",
                table: "UsersAuctions",
                column: "UserId");
        }
